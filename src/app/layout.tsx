...
export const metadata = {
  title:
    "מרכז קסם - מרכז למידה למתמטיקה בגבעת שמואל | רעננה | קריית אונו - שיעורים פרטיים במתמטיקה? מרכז קסם",
  description:
    "לימודי מתמטיקה מותאמים אישית בגבעת שמואל, רעננה וקריית אונו, מכיתה ו' עד י\"ב והגילאים.",
};
