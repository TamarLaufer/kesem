...
export const metadata = {
  title:
    "מרכז קסם - מרכז למידה למתמטיקה בגבעת שמואל | רעננה | קריית עקרון - שיעורים פרטיים במתמטיקה? מרכז קסם",
  description:
    "לימודי מתמטיקה מותאמים אישית בגבעת שמואל ורעננה, מכיתה ו' עד י\"ב והגילאים.",
};
